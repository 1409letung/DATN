...
<body>
    ...
    <nav>
        <?php
           //$date = $sql['ngaydat'];
           list($year, $month, $day) = explode('-', $sql['ngaythuchien']); 
           echo "Ngày $day, tháng $month năm $year";
        ?>
    </nav>
    <main>
        <h4 style="text-align: center;"> KẾT QUẢ XÉT NGHIỆM </h4>
        <br>
