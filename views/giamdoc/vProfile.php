		...
		if($passNow != $info['password']){
			...
			if($passNew != $rePassNew){
				...
				if($rs){
					...
					header('refresh:1;Location:Giamdoc.php?action=show&query=profile');
				}else{
                    unset($_POST['resetPass']);
...
<div class="modal" id="modalUpdate">
    ...
    if(isset($_POST['updateTTCN'])){
        ...
        if(!$hoten || !$ngaysinh || !$gioitinh || !$diachi || !$sdt || !$email || !$vtcv){
            ...
            echo  '<meta http-equiv="refresh" content="3;url=Giamdoc.php?action=show&query=profile">';
        }else
        {
            ...
            if($kq){
                ...
                echo  '<meta http-equiv="refresh" content="0;url=Giamdoc.php?action=show&query=profile">';
            }else{
                unset($_POST['updateTTCN']);
