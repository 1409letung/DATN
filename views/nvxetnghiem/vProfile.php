                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <span type="url" class="form-control"
                                    id="website"><?php echo $info['congviec'] ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="row gutters">
		...
		if($passNow != $info['password']){
			...
			if($passNew != $rePassNew){
				...
				if($rs){
					...
					header('refresh:1;Location:NVXetNghiem.php?action=show&query=profile');
				}else{
                    unset($_POST['resetPass']);
...
<div class="modal" id="modalUpdate">
    ...
    if(isset($_POST['updateTTCN'])){
        ...
        if(!$hoten || !$ngaysinh || !$gioitinh || !$diachi || !$sdt || !$email || !$vtcv){
            ...
            echo  '<meta http-equiv="refresh" content="3;url=NVXetNghiem.php?action=show&query=profile">';
        }else
        {
            ...
            if($kq){
                ...
                echo  '<meta http-equiv="refresh" content="0;url=NVXetNghiem.php?action=show&query=profile">';
            }else{
                unset($_POST['updateTTCN']);
