    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: cyan;">
                <h4 class="modal-title" style="margin-left: 80px; color:MediumBlue;"> <b>Thông Tin Phiếu Xét Nghiệm Mới</b>
                </h4>
            ...
            <div class="modal-body">
                <form action="" method="POST" class="">
                    ...
                    <div class="form-group ">
                        ...
                        <select class="form-control" name="lxn" id="lxn">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="kq" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div class="form-group">
...
<table class="table bg-white rounded shadow-sm  table-hover col-4">
    <thead>
        <tr style="text-align: center;">
            ...
            <th scope="col" width="100">Mã PXN</th>
    ...
    <tbody>
        <tr style="text-align: center;">
            ...
            <td>
                ...
                <a href="?pxn=chuky&id=<?php echo $row['maPXN'];?>" style="text-decoration: none;">
                    <button type="button" value="submit" class="btn btn-info btn-sm" data-toggle="modal"
                        data-target="xemchitiet">
                        <i class="bi bi-pencil-square"> Ký xác nhận</i>
                    </button>
                </a>
                ...
                <a target="_blank" href="PrintPXN.php?id=<?php echo $row['maPXN'];?>&lxn=<?php echo $row['loaiXN']; ?>" style="text-decoration: none;">
