            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="NVXetNghiem.php?action=show&query=profile">Thông tin cá
                                nhân</a></li>
                        <li><a class="dropdown-item" href="NVXetNghiem.php?logout=1">Đăng xuất</a></li>
                    </ul>
                </li>
            </ul>
        </div>
