...
<body>
    ...
    <nav>
        <?php
           ...
           //$date = $sql['ngaydat'];
           list($year, $month, $day) = explode('-', $a['ngaythuchien']); 
           echo "Ngày $day, tháng $month năm $year";
        ?>
    </nav>
    <main>
        <h4 style="text-align: center;"> KẾT QUẢ XÉT NGHIỆM <?=$a['loaiXN'] ?></h4>
        <br>
    ...
    <?php
      if($a['loaiXN'] == 'MÁU TỔNG QUÁT')
      {
        ...
        echo '<tbody>';
            ...
            echo '
            <tr>
              <td>'.$row['congthucmau'].'</td>
              <td>'.$row['ketquaxetnghiem'].'</td>
              <td>'.$row['chisobinhthuong'].'</td>
              <td>'.$row['donvi'].'</td>
            </tr>';
             }
        echo '</tbody>'; 
      }
      elseif($a['loaiXN'] == 'NƯỚC TIỂU')
      {
        echo '<thead>
                 <tr>
                   <th>Thông số</th>
      ...
      elseif($a['loaiXN'] == 'VI SINH')
      {
        echo '<thead>
                <tr class="vs">
                 <th class="vs">Kháng sinh</th>
                 <th class="vs">S</th>
                 <th class="vs">I</th>
                 <th class="vs">R</th>
                </tr>
        ...
        echo '<tbody>';
            ...
            echo '
            <tr class="vs">
              <td class="vs">'.$row['khangsinh'].'</td>
              <td class="vs">'.$row['S'].'</td>
              <td class="vs">'.$row['I'].'</td>
              <td class="vs">'.$row['R'].'</td>
            </tr>';
             }
        echo '</tbody>';
      }
        ...
        <footer style="margin-top: -75px;">
            <div class="footer">
                ...
                <div class="chuky">
                    ...
                    <br>
                    <img src="<?php echo $base64; ?>" alt="ERROR IMG" width="150px" height="50px" />
                    <h5><?=$a['nguoithuchien']?></h5>
                </div>
