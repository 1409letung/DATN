...
<form method="POST" enctype="multipart/form-data">
  <div class="form-row">
    ...
    <a href="?c=baiviet&qr=chuyenkhoa&action">
    ...
    if($noidung != ''){
       if($p->upload($name,$tmp_name,$folder)==1){
            ...
            if($ex){
                ...
                echo '<script> 
                        window.location.href="admin.php?c=baiviet&qr=chuyenkhoa&action";
                        alert("Cập nhật thành công!");
                      </script>';
            }else{
                echo '<script> alert("Cập nhật thất bại!"); </script>';
                echo  '<meta http-equiv="refresh" content="url=admin.php?c=baiviet&qr=chuyenkhoa&action">';
            }
        }else{
