	...
	<div class="card-body">
		<div class="account-settings">
			<div class="user-profile">
				...
				<h5 class="user-name"><?php echo $rowBN['hoten']; ?></h5>
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="text" class="form-control" id="fullName" placeholder="Enter full name"> -->
                    <span type="text" class="form-control" id="fullName"><?php echo $rowBN['hoten'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="email" class="form-control" id="eMail" placeholder="Enter email ID"> -->
                    <span type="text" class="form-control" id="gioitinh"><?php echo $rowBN['gioitinh'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="email" class="form-control" id="eMail" placeholder="Enter email ID"> -->
                    <span type="date" class="form-control" id="ngaysinh"><?php echo $rowBN['ngaysinh'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="text" class="form-control" id="phone"><?php echo $rowBN['sdt'] ?></span>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="email" class="form-control" id="eMail" placeholder="Enter email ID"> -->
                    <span type="email" class="form-control" id="eMail"><?php echo $rowBN['email'] ?></span>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="url" class="form-control" id="website"><?php echo $rowBN['nghenghiep'] ?></span>
				</div>
			</div>
		</div>
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="name" class="form-control" id="Street"><?php echo $rowBN['diachi'] ?></span>
				</div>
			</div>
		</div>
        <br>
	...
	if(isset($_POST['resetPass'])){
		...
		if($passNow != $rowTK['password']){
			...
			if($passNew != $rePassNew){
                ...
                echo  '<meta http-equiv="refresh" content="0;url=benhnhan.php?action=show&query=profile">';
			}else{
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group ">
                    <label for="">Họ tên:</label>
                       <input type="text" class="form-control"  name="hoten" value="<?php echo $rowBN['hoten'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="pwd">Ngày sinh:</label>
                       <input type="date" class="form-control"  name="ngaysinh" value="<?php echo $rowBN['ngaysinh'] ?>">
                  </div>
				  <div class="form-group">
                    <label for="pwd">Giới tính:</label>
                       <input type="text" class="form-control"  name="gioitinh" value="<?php echo $rowBN['gioitinh'] ?>">
                  </div>
				  <div class="form-group ">
                    <label for="">Địa chỉ:</label>
                       <input type="text" class="form-control"  name="diachi" value="<?php echo $rowBN['diachi'] ?>">
                  </div>
				  <div class="form-group">
                    <label for="">Số điện thoại:</label>
                       <input type="text" class="form-control"  name="sdt" value="<?php echo $rowBN['sdt'] ?>">
                  </div>
				  <div class="form-group ">
                    <label for="">Email:</label>
                       <input type="text" class="form-control"  name="email" value="<?php echo $rowBN['email'] ?>">
                  </div>
				  <div class="form-group ">
                    <label for="">Nghề nghiệp:</label>
                       <input type="text" class="form-control"  name="nghenghiep" value="<?php echo $rowBN['nghenghiep'] ?>">
                  </div>
				  <div class="modal-footer">
					<button type="submit" name="updateTTCN" class="btn btn-primary btn-footer" style="text-align: center;">Xác nhận</button>
                  </div>
                 </form>
               </div>
...
<?php
    if(isset($_POST['updateTTCN'])){
        ...
        {
            $kq = $p->updateTTCN($maBN,$hoten,$ngaysinh,$gioitinh,$diachi,$sdt,$email,$nghenghiep);
