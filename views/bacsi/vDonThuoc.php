...
<hr>
<!-- Start Đơn đăng ký -->
<a href="?c=qlkb&qr=dt&action=add" style="text-decoration: none;">
    <button type="button" class="btn btn-success btn-sm" style="margin-left: 20px;">
        Đơn thuốc mới
    </button>
</a>
    ...
    <tbody>
        <tr style="text-align: center;">
            ...
            <td>
                ...
                <a href="?dt=sua&id=<?php echo $rs['maPKB']; ?>" style="text-decoration: none;">
                    <button type=" button" value="submit" class="btn btn-info btn-sm">
