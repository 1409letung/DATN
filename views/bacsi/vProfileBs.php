	...
	<div class="card-body">
		<div class="account-settings">
			<div class="user-profile">
				...
				<h5 class="user-name">Bs.<?php echo $rowBS['hoten']; ?></h5>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="text" class="form-control" id="fullName" placeholder="Enter full name"> -->
                    <span type="text" class="form-control" id="fullName"><?php echo $rowBS['hoten'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="text" class="form-control" id="gioitinh"><?php echo $rowBS['gioitinh'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="email" class="form-control" id="eMail" placeholder="Enter email ID"> -->
                    <span type="date" class="form-control" id="ngaysinh"><?php echo $rowBS['ngaysinh'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="text" class="form-control" id="phone"><?php echo $rowBS['sdt'] ?></span>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<!-- <input type="email" class="form-control" id="eMail" placeholder="Enter email ID"> -->
                    <span type="email" class="form-control" id="eMail"><?php echo $rowBS['email'] ?></span>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="url" class="form-control" id="website"><?php echo $rowBS['vitricongviec'] ?></span>
				</div>
			</div>
		</div>
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="name" class="form-control" id="Street"><?php echo $rowBS['diachi'] ?></span>
				</div>
			</div>
		</div>
        <br>
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-center">
					<button type="button" id="submit" data-toggle="modal" data-target="#modalUpdate" name="submit" class="btn btn-primary">Cập nhật thông tin </button>
				</div>
			</div>
		</div>
	</div>
...
<?php
	if(isset($_POST['resetPass'])){
		...
		if($passNow != $rowTK['password']){
            ...
            echo  '<meta http-equiv="refresh" content="0;url=bacsi.php?action=show&query=profile">';
		}else{
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group ">
                    <label for="">Họ tên:</label>
                       <input type="text" class="form-control"  name="hoten" value="<?php echo $rowBS['hoten'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="pwd">Ngày sinh:</label>
                       <input type="date" class="form-control"  name="ngaysinh" value="<?php echo $rowBS['ngaysinh'] ?>">
                  </div>
				  <div class="form-group">
                    <label for="pwd">Giới tính:</label>
                       <input type="text" class="form-control"  name="gioitinh" value="<?php echo $rowBS['gioitinh'] ?>">
                  </div>
				  <div class="form-group ">
                    <label for="">Địa chỉ:</label>
                       <input type="text" class="form-control"  name="diachi" value="<?php echo $rowBS['diachi'] ?>">
                  </div>
				  <div class="form-group">
                    <label for="">Số điện thoại:</label>
                       <input type="text" class="form-control"  name="sdt" value="<?php echo $rowBS['sdt'] ?>">
                  </div>
				  <div class="form-group ">
                    <label for="">Email:</label>
                       <input type="text" class="form-control"  name="email" value="<?php echo $rowBS['email'] ?>">
                  </div>
				  <div class="form-group ">
                    <label for="">Nghề nghiệp:</label>
                       <input type="text" class="form-control"  name="vtcv" value="<?php echo $rowBS['vitricongviec'] ?>">
                  </div>
				  <div class="modal-footer">
					<button type="submit" name="updateTTCNBs" class="btn btn-primary btn-footer" style="text-align: center;">Xác nhận</button>
                  </div>
                 </form>
</div>
<?php
    if(isset($_POST['updateTTCNBs'])){
        $hoten       = $_POST['hoten'];
        ...
        {
            $kq = $p->updateTTCNYBs($maBS,$hoten,$ngaysinh,$gioitinh,$diachi,$sdt,$email,$vtcv);
            
            if($kq){
                unset($_POST['updateTTCNBs']);
