        ...
        <div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="text" class="form-control" id="fullName"><?php echo $info['username']; ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="eMail">Mật khẩu</label>
                    <input type="password" class="form-control" readonly value="<?php echo $info['password'] ?>">
				</div>
			</div>
		...
		<div class="row gutters">
            ...
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="text" class="form-control" id="gioitinh"><?php echo $info['gioitinh'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="eMail">Ngày sinh</label>
                    <span type="date" class="form-control" id="ngaysinh"><?php echo $info['ngaysinh'] ?></span>
				</div>
			</div>
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
                    ...
                    <span type="url" class="form-control" id="website"><?php echo $info['congviec'] ?></span>
				</div>
			</div>
		</div>
		<div class="row gutters">
		...
		if($passNow != $info['password']){
			...
			if($passNew != $rePassNew){
				...
				if($rs){
					...
					header('refresh:1;Location:NVTiepNhan.php?action=show&query=profile');
				}else{
                    unset($_POST['resetPass']);
               ...
               <div class="modal-body">
				  ...
				  <div class="form-group ">
                    <label for="">Nghề nghiệp:</label>
                       <input type="text" class="form-control"  name="vtcv" value="<?php echo $info['congviec'] ?>">
                  </div>
				  <div class="modal-footer">
...
<?php
    if(isset($_POST['updateTTCN'])){
        ...
        if(!$hoten || !$ngaysinh || !$gioitinh || !$diachi || !$sdt || !$email || !$vtcv){
            ...
            echo  '<meta http-equiv="refresh" content="3;url=NVTiepNhan.php?action=show&query=profile">';
        }else
        {
            ...
            if($kq){
                ...
                echo  '<meta http-equiv="refresh" content="0;url=NVTiepNhan.php?action=show&query=profile">';
            }else{
                unset($_POST['updateTTCN']);
