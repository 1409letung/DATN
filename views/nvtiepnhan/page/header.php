                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="NVTiepNhan.php?action=show&query=profile">Thông tin cá nhân</a></li>
                                <li><a class="dropdown-item" href="NVTiepNhan.php?logout=1">Đăng xuất</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                    ...
                    <form action="NVTiepNhan.php?search=key" method="POST">
                       <div class="input-group">
                        ...
                        <div class="form-outline">
                          <input type="search" name="keyword" class="form-control" placeholder="Tìm kiếm..."  style="width: 400px;"/>
                        </div>
